...
const WinnerBox = () => {
  return (
    <div className="h-full w-1/2 relative">
      <Image src={mainImg} alt="bg-main " />
      <div className="w-64 absolute top-10 left-[6%]">
      <CustomTab buttonArray={loginStatus} color={"default"}/>
      </div>
      <div className="w-[88%] absolute -mt-20 xl:bottom-14 bottom-10 right-[6%] mx-auto bg-zinc-700/70 backdrop-blur-sm p-4 rounded-3xl flex gap-3">
        <Image src={group} alt="bg-main " />
